--[[
    1NXITER UI LIBRARY v5.1 (PROFILE FIX)
    Estilo: Red Dark / Rounded / Big UI
    Atualização: Adicionado HWID, Key Vitalícia e Versão no Perfil.
]]
...
local HttpService = game:GetService("HttpService") -- Necessário para gerar HWID
...
function Library:CriarJanela(NomeScript)
	...
	function UI:CriarAba(Icone)
		...
		-- > PROFILE (ATUALIZADO COM HWID E KEY)
